...
/mob/living/carbon/human/Initialize(mapload, new_species)
	...
	hud_list[BLINK_HUD]       = new /image/hud_overlay('icons/mob/hud_blink.dmi', src, "15") //This is a little janky because the health and blink huds are similiar but I doubt 173 will ever wear health_HUD glasses
...
/mob/living/carbon/human/get_status_tab_items()
	...
	if(istype(back,/obj/item/rig))
		...
		. += "Suit charge: [suit.cell ? "[suit.cell.charge]/[suit.cell.maxcharge]" : "ERROR"]"

	if(mind?.changeling)
		. += "Chemical Storage: [mind.changeling.chem_charges]"
		. += "Genetic Damage Time: [mind.changeling.genetic_damage]"
...
/mob/living/carbon/human/help_shake_act(mob/living/carbon/M)
	if(src != M)
		...
		visible_message( \
			SPAN_NOTICE("[src] examines [p_themself()]."), \
